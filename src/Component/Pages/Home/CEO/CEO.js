    ...
    return (
        <section style={{
            ...
            <div className='flex-1 p-10'>
                ...
                <h2 className='text-3xl text-orange-500 py-10'>Shad Ullah Sakib</h2>
                <p className=''>For last 2 years, Our leader Shad Ullah Sakib continues to grow our company <br /> with his consistency, integrity and punctuality. His vision will inspire you.</p>
            </div>
        </section>
    );
};
